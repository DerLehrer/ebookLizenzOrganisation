...
<?php elseif (isset($_SESSION["benutzer"])) : ?>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbarLg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item nav-item-aktiviert">
                        <a class="nav-link  navlink-aktiviert" href="codes.php">Codes</a>
                    </li>
                    <li class="nav-item ">
        ...
        <div class="container-fluid ">
            <div class="horizontalzentriert">
                <table class="zentriertesTab" id="inhalte">
                    ...
                    <tr>
                        <td class="zentriertesTab">
                            <div id="output"><table id="seitentabelle" class="table "  style="width:100%"><thead><tr><th></th><th>Buch</th><th>Codes</th><th>Verwendung</th><th>Menge</th></tr></thead><tbody></tbody></table></div>
                        </td>
                    </tr>
                    </td>
                    </tr>
        ...
        <div style="display:none;">
            <div id="dialog-loeschen" title="Eintr&auml;ge l&ouml;schen?">
                <table>
                    ...
                    <tr>
                        <td>
                            <div class="ui-state-error" style="background-color: white; border:0px"><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span></div>
                        </td>
                        <td>Wollen Sie die ausgew&auml;hlten Eintr&auml;ge wirklich l&ouml;schen?<br>
                            Der Prozess kann nicht r&uuml;ckg&auml;ngig gemacht werden!</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div id="dialog-zuordnen" title="Codes zuordnen">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="verteiltext">Wollen Sie die noch nicht zugeordneten Codes auf die vorhandenen Bestellungen verteilen?<br>
        ...
        <div id="gesetzliches" class="gesetzliches g-gruen">
            ...
            <div id="seitenid" style="display:none;">codes</div>
    </body>
