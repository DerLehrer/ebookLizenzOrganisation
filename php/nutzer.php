    ...
    <head>
     ...
     <body>
        <nav class="navbar navbar-expand-lg bg-success navbar-dark" >
          ...
          <ul class="navbar-nav">
                    ...
                    <li class="nav-item nav-item-aktiviert">
                        <a class="nav-link navlink-aktiviert" href="nutzer.php">Nutzer</a>
                    </li>
                      <li class="nav-item ">
                        <a class="nav-link" href="buch.php">B&uuml;cher</a>
                    </li>
                     <li class="nav-item" >
                        <a class="nav-link " href="bestellungen.php">Bestellungen</a>
                    </li>
                      <li class="nav-item " >
        ...
        <div class="container-fluid " >
            <div class="horizontalzentriert">
                <table class="zentriertesTab" id="inhalte">
                    ...
                    <tr><td>
                     ...
                     <tr>
                        <td class="zentriertesTab">
                             <div id="output"><table id="seitentabelle" class="table "  style="width:100%"><thead><tr><th></th><th>Email-Adresse</th><th>Name</th><th>Klasse</th><th>eingeladen</th><th>hat sich registriert</th><th>Bestellkosten</th></tr></thead><tbody></tbody></table></div>
                        </td>
                    </tr>    
                        </td>
                    </tr>
            ...
            <script type="text/javascript" src="../js/controllerVerwaltung.js?v2"></script>
...
<div style="display:none;">
<div id="dialog-einladen" title="Einladungen verschicken">
<table><th></th><th></th><tr><td ><div class="ui-state-error" style="background-color: white; border:0px"><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span></div></td>
<td>Wollen Sie wirklich eine Einladung per Email an bis zu 40 Nutzer verschicken?<br>
  Den Text der Einladung finden Sie unter "Einstellungen".</td></tr></table>
</div>
 </div>
</div>
...
<div id="seitenid" style="display:none;">nutzer</div>
</body>
</html>
<?php endif; ?>