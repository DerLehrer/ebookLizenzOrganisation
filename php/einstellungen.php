            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbarLg">
              <ul class="navbar-nav">
                    ...
                    <li class="nav-item nav-item-aktiviert" >
                        <a class="nav-link navlink-aktiviert" href="einstellungen.php">Einstellungen </a>
                    </li>
                </ul>
            </div>
        </nav>
...
<div id="dialog-reset" title="Daten des Schuljahres l&ouml;schen?">
...
<td>Wollen Sie wirklich alle Eintr&auml;ge des Schuljahres l&ouml;schen?<br>
...
<div id="seitenid" style="display:none;">einstellungen</div>
